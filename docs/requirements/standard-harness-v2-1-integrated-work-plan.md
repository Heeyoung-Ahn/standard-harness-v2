...
```text
Create: _harness/requirements/requirements-index.yaml
Create: _harness/requirements/traceability-matrix.yaml
Create: _harness/requirements/hr-coverage-matrix.yaml
...
Create: src/standard_harness/requirements/metadata.py
