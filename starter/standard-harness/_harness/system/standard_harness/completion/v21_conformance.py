...
class V21ConformanceGate:
    ...
    def evaluate(self) -> dict[str, Any]:
        ...
        coverage = self._read("_harness/contracts/hr-coverage-matrix.yaml")["coverage"]
        metadata = self._read("_harness/contracts/hr-coverage-matrix.yaml")
        traceability = self._read("_harness/contracts/traceability-matrix.yaml")["traceability"]
